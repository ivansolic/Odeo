<!-- Thanks for contributing to Odeo. Contributions of every kind are welcome, not just code. -->
...
<!-- The problem it solves or the improvement it makes. Link an issue if there is one: Closes #NNN -->

## Type of change

- [ ] Docs (README, BEGINNERS-GUIDE, WORKFLOW, comments)
...
<!-- Anything that needs a closer look, or open questions. -->
